                        ...
                        "should": [  #
                            ...
                            },
                            {
                                "multi_match": {
                                    ...
                                    "fields": [search_field + "^10", "name.hyphens^10", "shortDescription^5",
...
if __name__ == "__main__":
    ...
    general.add_argument('--synonyms', action='store_true',
                         help='if field --> name.synonyms instead of name') 
    ...
    for line in sys.stdin:
        ...
        if query == "Exit":
            break
        search(client=opensearch, user_query=query, index=index_name, search_field=search_field)
