...
def create_rescore_ltr_query(user_query: str, query_obj, click_prior_query: str, ltr_model_name: str,
    ...
    # print(click_prior_query)
    # print(ltr_model_name)
    # print(ltr_store_name)
    # print(active_features)
    # print(rescore_size)
    # print(main_query_weight)
    # print(rescore_query_weight)
...
def create_feature_log_query(query, doc_ids, click_prior_query, featureset_name, ltr_store_name, size=200, terms_field="_id"):
    ...
    # print(query, doc_ids, click_prior_query, featureset_name, ltr_store_name, size, terms_field)

    ids_doc = [str(x) for x in doc_ids]
